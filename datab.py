...
'''
#create a function to to save edited function
def update():
    conn  = sqlite3.connect('address_book.db')
    #create cursor
    c=conn.cursor()
...
def edit():
    ...
    save_btn = Button(editor, text='save edited', command = update)
...
#create function to delete a reccord
def delete():
    conn  = sqlite3.connect('address_book.db')
...
#create sbmit function for database
def submit():
...
update_btn = Button(root, text='update  records', command= edit)
update_btn.grid(row=12,column = 0,columnspan =2,pady=10,padx=10,ipadx=136)
